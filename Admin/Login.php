...
<body class=" text-center d-flex align-items-center py-4 bg-body-tertiary">
    <main class="form-signin w-100 m-auto">
        <form class="needs-validation" novalidate action="ProsesLogin.php" method="POST">
            ...
            <div class="form-check d-flex justify-content-center text-center my-3">
                <input class="form-check-input me-2" type="checkbox" value="remember-me" id="checkDefault">
                <label class="form-check-label" for="checkDefault">
                    Remember me
                </label>
            </div>
            <button class="btn btn-primary w-100 py-2" type="submit" name="submit_validasi" value="123">Login</button>
